...
| Question bank | **Settled 2026-09-10 by Grant:** 36 families × 8 ≈ 290 at launch, grow toward ~500; 12-month retirement preferred; never repeat a prompt; no family within a rolling 8 sessions; 70/30 weighted/random; full-board draw as in `recruit_question_bank.md`. **Family pass 1 complete 2026-09-10** (all 36 KEEP; MOT-1 as drafted after skipped widget; JOB-3 prep-only; JUD-4 citizen-level opinion trap; CMT-2 / CON-2 / SLF-3 THIN). Pass 2 pending. Nothing publishes unreviewed. Does not wire the live scorer or pricing. |
