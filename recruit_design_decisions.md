...
> **Closed 2026-07-28 in draft; Grant-approved 2026-09-10.** Teamwork level 2 is that anchor (`recruit_rubric_c3_teamwork.md`).
...
- Where the wording is actually *in* the answer it is not a risk; the anchors and note 5 govern it. **Note 5 settled 2026-09-10:** the claim is critique only and does not move the band by itself. Note 10 still governs when the claim is *absent*.
...
| | Count | Who |
|---|---|---|
| Decisions only Grant can make | remaining items below (C2 route tags; reuse-risk definition; distribution; C2 note 7; metrics; bank). C3 Grant-to-take items from the 2026-09-10 text pass are closed | Grant |
| Reading (not deciding) — the C3 rewrite he has not read | 0 | — |
| Authoring — C1–C5 adjacent-band / text-pass rewrites (all Grant-approved / publishable 2026-09-10; C2 already SME-approved) | 0 | — |
...
**C3 drops route tags (Grant 2026-09-10).** The C3-specific route-tag rows below are
struck: clean 1–5; critique may still name which axis is short (wants the crew vs handles
people) in prose. **C2’s 4A/4B split remains its own row** — this pass does not close C2’s
split. The standing *4A/4B split* entry is C2’s unless already settled there.
...
| Criterion 3 | **Grant-approved / publishable 2026-09-10** (`recruit_rubric_c3_teamwork.md`). Rewritten earlier from Grant’s blind scores; captain text pass kept adjacent bands as drafted (5↔4, 4↔3, 3↔2, 2↔1). Structure: **clean 1–5, no 4A/4B route tags** (critique may still name which axis is short in prose). Note 5 closed: “I’ve always gotten along with everyone” is critique only and does not move the band by itself (anchors 2/3 already catch cast-missing and mush; note 10 still governs when the claim is absent). “Takes an action” at 4 vs 3: the other person must **change the situation** (fix / take a task / escalate / teach / cover); reply-only does not clear the bar. Being-changed reaches 5 on its own when lasting change from a hard conversation with a named colleague still carries — no second behaviour required beside it. Does not wire the live scorer or pricing. |
...
| ~~**C3 — does being changed by a colleague need a second behaviour beside it?**~~ | **Settled 2026-09-10 (Grant):** being-changed reaches 5 on its own when lasting change from a hard conversation with a named colleague still carries. No second behaviour required beside it. Confirm/keep; close the open “Grant’s to take.” Discriminator across the ruled answers remains **conduct that outlasts the episode**. |
...
| ~~**C3 — the narrowed clause names a destination the pipeline does not take**~~ | **Closed 2026-09-10:** C3 drops route tags; score is a bare 1–5. The destination is a 4. Historical 4B landings are retired tags, not a live routing defect. C2’s 4A/4B split remains its own row. |
...
| ~~**C3 — 4A is a dead letter**~~ | **Closed 2026-09-10:** C3 drops 4A/4B route tags. Score is a bare 1–5. Historical evidence that 4A was absorbing rather than discriminating stands as the reason the tags were dropped on this criterion. C2’s split remains its own row. |
| ~~**The 4A/4B split has nowhere to put a competent, warm, single-incident answer**~~ | **Closed for C3 on 2026-09-10:** C3 drops route tags; a competent single-incident answer is a bare 4. The two-axes insight (wanting vs able) remains critique guidance only. C2’s 4A/4B split remains its own row. |
...
| ~~**C3 — anchor 4 gained a third route, unrouted**~~ | **Closed 2026-09-10:** C3 is clean 1–5; the middle way into a 4 (one piece of the conduct done well) is a bare 4, not a missing tag. Two-axes diagnosis stays in critique prose. |
...
| ~~C3 — where the unfalsifiable-claim flag lands~~ | **Settled 2026-09-10 (Grant).** Scoring note 5: the claim *“I’ve always gotten along with everyone”* is **critique only; it does not move the band by itself.** Anchors 2/3 already catch cast-missing and mush. Note 10 still governs when the claim is *absent* (delivery risk, no score move). |
| ~~C3 — what counts as "an action" at the 4 boundary~~ | **Settled 2026-09-10 (Grant).** The other person must **change the situation** (fix something, take a task, escalate, teach, cover). Reply-only such as *“I’m fine”* / *“things are fine”* does **not** clear the 4 vs 3 bar. |
...
| Criteria 4, 5 | **Named 2026-09-10: C4 Integrity & Ethics; C5 Judgment & Composure.** Structure: designated+corroboration; clean 1–5. C4: never-refuse-any-order = low-band tell; escalate past peer talk for harm/theft/impairment/illegal; C3/C5 overlap as drafted; corroboration may move the designated band by at most one. **C4 Grant-approved / publishable 2026-09-10** (adjacent bands 5↔4, 4↔3, 3↔2, 2↔1 kept as drafted). C5: composure = conduct/content only (no voice-quality); self-awareness mostly C5; ranking traps score reasoning not secret correct order; corroboration may move the designated band by at most one. **C5 Grant-approved / publishable 2026-09-10** (adjacent bands 5↔4, 4↔3, 3↔2, 2↔1 kept as drafted; 5↔4 kept after a mis-tap that briefly said rewrite). Does not wire the live scorer or pricing. C1 and C3 are Grant-approved / publishable 2026-09-10. All five criteria (C1–C5) are now publishable for scoring (C2 already SME-approved). |
...
| 4A/4B split | **C3 drops route tags (Grant 2026-09-10)** — clean 1–5; two-axes insight is critique guidance only. **C2’s 4A/4B split remains open** unless already settled on that criterion: it came out of a single pass and wants a second panelist. This pass does not unilaterally rewrite C2. |
| Question bank | **Settled 2026-09-10 by Grant:** 36 families × 8 ≈ 290 at launch, grow toward ~500; 12-month retirement preferred; never repeat a prompt; no family within a rolling 8 sessions; 70/30 weighted/random; full-board draw as in `recruit_question_bank.md`. **Family pass 1 + variant pass 2 complete 2026-09-10** (all 36 KEEP; 16 struck; **272 survive**). Publish gate was a separate start order; **START ORDER 2026-09-11** opens non-C2 publish and C1–C5 scorer wire. Recruit paid go-live approved the same day (see `badgeday_pricing.md`); live IDs remain ops. Promote paid go-live approved later the same day (evening START ORDER — see `badgeday_pricing.md`). |
...
- **C4 named Integrity & Ethics.** Structure: designated+corroboration; clean 1–5; never-refuse-any-order = low-band tell; escalate past peer talk for harm / theft / impairment / illegal; C3/C5 overlap as drafted; corroboration may move the designated band by at most one. **Grant-approved / publishable 2026-09-10** (adjacent bands 5↔4, 4↔3, 3↔2, 2↔1 kept as drafted). Does not wire the live scorer or pricing.
- **C5 named Judgment & Composure.** Structure: designated+corroboration; clean 1–5; composure = conduct/content only (no voice-quality); self-awareness mostly C5; ranking traps score reasoning, not a secret correct order; corroboration may move the designated band by at most one. **Grant-approved / publishable 2026-09-10** (adjacent bands 5↔4, 4↔3, 3↔2, 2↔1 kept as drafted; 5↔4 kept after a mis-tap that briefly said rewrite). Does not wire the live scorer or pricing. Criteria 1 and 4 are already Grant-approved.
- Draft files on main via PR 46: `recruit_rubric_c1_answer_construction.md`, `recruit_rubric_c4_integrity_ethics.md`, `recruit_rubric_c5_judgment_composure.md`. **C1, C4, and C5 Grant-approved / publishable 2026-09-10** (adjacent bands kept as drafted; C4/C5 corroboration ±1). Approval does not wire the live scorer or pricing. Do not invent measurement numbers.
- C2 remains SME-approved.
- **C3 Teamwork & Interpersonal Grant-approved / publishable 2026-09-10** after Grant’s captain text pass. Settles: clean 1–5, drop 4A/4B route tags (critique may still name which axis is short in prose); note 5 closed — “I’ve always gotten along with everyone” is critique only and does not move the band by itself (note 10 still governs when the claim is absent); “takes an action” at 4 vs 3 requires the other person to **change the situation** (reply-only does not clear); being-changed reaches 5 on its own; adjacent bands 5↔4, 4↔3, 3↔2, 2↔1 kept as drafted. Authoring backlog for C3 text pass / adjacent-band rewrite is **0**. No unpublished Recruit oral-board criterion remains for authoring. Does not wire the live scorer or pricing.
- **Question bank sizing and rotation settled 2026-09-10:** 36 families × 8 ≈ 290 at launch, grow toward ~500; 12-month retirement preferred; never repeat a prompt; no family within a rolling 8 sessions; 70/30 weighted/random; full-board draw shape as already described in `recruit_question_bank.md`. Family review of the existing 288-item draft started 2026-09-10 (not a second library). Pass 1 + pass 2 complete the same day; **272 survive**. Publishing was a separate start order; **START ORDER 2026-09-11** opens non-C2 publish. Recruit paid go-live approved the same day (see `badgeday_pricing.md`); live IDs remain ops. Promote paid go-live approved later the same day (evening START ORDER — see `badgeday_pricing.md`).
- **Question bank family pass 1 complete 2026-09-10 (Grant):** all 36 families KEEP. MOT-1 kept as drafted after a skipped widget; recommendation stood. JOB-3 KEEP family, **prep-only** — pass 2 to strike who-they-are / marital-kids inventory / soft “how does your family feel” (item 1 especially); score preparation, never domestic arrangements (Red agreed). JUD-4 KEEP as citizen-level opinion trap (score defence, not order); pass 2 to strike knowledge-gated / budget items (engine-vs-prevention funding; anything needing org-chart, NFPA, or apparatus knowledge); keep suppression/prevention/education and fire-vs-medical-vs-rescue style as opinion (Red confirmed). CMT-2, CON-2, SLF-3 KEEP, flagged THIN — expect fewer than 8 variants to survive pass 2. Pass 2 applied the same day; see the next bullet. Family review (pass 1+2) is complete; **272 survive**. Publishing into product was a separate start order; **START ORDER 2026-09-11** opens non-C2 publish. Recruit paid go-live approved the same day (see `badgeday_pricing.md`); live IDs remain ops. Promote paid go-live approved later the same day (evening START ORDER — see `badgeday_pricing.md`).
- **Question bank variant pass 2 complete 2026-09-10 (Grant):** 16 struck, **272 survive**. Flagged-family strikes: JOB-3 items 1, 2, 8 (prep-only); JUD-4 item 3 (engine vs prevention funding); CMT-2 item 6; CON-2 items 6, 8; SLF-3 items 5, 8. Batch-skim exceptions (Red accepted; Grant accepted all seven): INT-4.1, INT-4.4, STR-3.6, JOB-1.2, JOB-2.6, JOB-4.5, OPN-2.6. All other items KEEP. Review of families and variants is complete. Publishing into product was a separate start order; **START ORDER 2026-09-11** opens non-C2 publish. Recruit paid go-live approved the same day (see `badgeday_pricing.md`); live IDs remain ops. Promote paid go-live approved later the same day (evening START ORDER — see `badgeday_pricing.md`).
- **C2-only bank publish 2026-09-10 (Grant start order):** 81 issuable MOT/JOB/CMT prompts (non-STRIKE) are the live bank. Hold issuing C1/C3/C4/C5 until scorer wire. Hold full board of five, family-within-8, 70/30, retirement. Legacy `scenario_id=c2` is frozen and aliased by exact wording so novelty stays honest. **Superseded 2026-09-11** — C2-only ~81 was the prior live bank. This order’s holds on full board of five, non-C2 issue, and scorer wire are lifted by **START ORDER 2026-09-11** below. Legacy `scenario_id=c2` aliasing still stands.
- ~~Five-question board *build* and live scorer wire remain held — implementation hold, not a rubric hold. Session shape is settled; implementation is not started.~~ **Superseded 2026-09-11.** The 2026-09-10 line that held full board of five / held non-C2 issue / held scorer wire for implementation is closed. Build is open — see START ORDER 2026-09-11.

### START ORDER 2026-09-11 (Grant)

Locked by Grant 2026-09-11 via Zazu. Spec id **BD-R-003** (Geppetto BD-R-003 full board of five). Treat these locks as authoritative. This order **supersedes** the 2026-09-10 implementation hold on full board of five, non-C2 issue, and live scorer wire. C2-only ~81 was the prior live bank; this order opens non-C2 publish and the full-board build so the draw shape is real, not a C2-only fake board. **Recruit paid go-live is approved** separately the same day (see `badgeday_pricing.md`); live IDs remain ops. Board Phase 0 does not itself configure Stripe products or invent price IDs, but paid go-live is **no longer held**. Promote paid go-live approved later the same day (evening START ORDER — see `badgeday_pricing.md`).
...
5. **Recruit paid go-live approved 2026-09-11** (see `badgeday_pricing.md`). Live Stripe price IDs and Play product IDs remain ops (Zazu); blank placeholders expected. Board Phase 0 does not itself configure Stripe products or invent price IDs, but paid go-live is **no longer held**. Promote paid go-live was opened later the same day (evening START ORDER — **$29/mo** + **$129** 90-day; live Stripe IDs ops-filled; Play production publish **in flight** — see `badgeday_pricing.md`) and is out of this Recruit board START ORDER.
...
If `specs/` later holds BD-R-003, implementers should read that file. Until then, **Geppetto BD-R-003 full board of five** is the spec name.
