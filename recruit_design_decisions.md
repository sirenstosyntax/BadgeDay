...
| Authoring — C1 adjacent-band rewrite (structure draft landed PR 46; not publishable). C4 and C5 no longer need adjacent rewrite (Grant-approved / publishable 2026-09-10). | 1 | Grant |
