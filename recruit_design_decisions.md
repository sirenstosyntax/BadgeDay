...
- Question bank growth, five-question board *build*, and live scorer wire remain held until Grant opens them — implementation hold, not a rubric hold. Session shape is settled; implementation is not started. Do not invent a start order.
