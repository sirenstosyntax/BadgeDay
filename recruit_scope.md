...
4. **Content set.** Enough scenarios and rubrics across question types to make a practice
   ...
   **Settled 2026-09-10 by Grant** — see open question 4 and `recruit_question_bank.md`.
   Family review of the existing 288-item draft is **complete** (pass 1+2, 2026-09-10; **272 survive**). Unreviewed items still do not publish; **START ORDER 2026-09-11** opens non-C2 publish of reviewed stock.
...
4. ~~**Question bank size and rotation policy.**~~ **Settled 2026-09-10 by Grant** in
   ...
   D/E/F, G/H, J). Family review of the existing 288-item draft is **complete** (pass 1+2; **272 survive**; not a second library). Unreviewed items still do not publish; **START ORDER 2026-09-11** opens non-C2 publish of reviewed stock. **START ORDER 2026-09-11** opens
