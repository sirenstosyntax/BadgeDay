...
def main() -> None:
    ...
    print(
        ...
        "\n"
        "**One run per answer cannot tell a divergence from a wobble — and it cannot tell\n"
        "agreement from one either.** This is one draw each. An answer sitting on a boundary\n"
        "has a rate, not a value: E was measured at n=20 on 2026-08-10 as 5x8 / 4Bx11 / 4x1,\n"
        "so it agrees in two runs out of five and 'diverges' in three, with nothing having\n"
        "changed. A clean table is therefore weak evidence in both directions — it rules out a\n"
        "gross change and rules out nothing subtler. Before treating any single-run result as\n"
        "a finding, get a rate for it:\n"
        "\n"
